...
<div class="footer">
    ...
    <div class="footer-heading footer-2 option1 option2">
        ...
        <a href="#">Add Expired Drugs</a><br />
        <a href="/add">Expired Drug List</a><br />
    ...
    <div class="footer-heading footer-4 option2">
        <h2>Maps</h2>
        <a href="https://goo.gl/maps/EXUFRzFMCEasMyH16"><img class="map" src="asserts/map.jpeg" height="160px" width="250px" /></a>
    </div>
</div>
