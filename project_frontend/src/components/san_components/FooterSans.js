...
<div class="footer">
    ...
    <div class="footer-heading footer-2 option1 option2">
        ...
        <a href="/addsup">Add Supplier</a><br />
        <a href="/view">View Suppliers</a><br />
        <a href="/inventory">Inventory Report</a><br />
        <a href="/invoices">Issued Invoices</a><br />
    ...
    <div class="footer-heading footer-4 option2">
        <h2>Maps</h2>
        <a href="https://goo.gl/maps/EXUFRzFMCEasMyH16"><img class="map" src="san-asserts/map.png" height="160px" width="250px" /></a>
    </div>
</div>
