...
onSubmit = (e) => {
  ...
  axios.put(`http://localhost:8070/request/update/${id}`,data).then((res)=>{
            ...
            <div className="container-fluid" style={stylenav}>
              <div>
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    <a className="nav-link active" aria-current="page"  href="/updatestat">Update Request Status</a>
                  </li>
                  <li className="nav-item">
