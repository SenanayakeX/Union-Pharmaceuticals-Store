...
<div class="footer">
    ...
    <div class="footer-heading footer-2 option1 option2">
        ...
        <a href="/add">Received Orders</a><br />
        <a href="/displayAccOrders">View Accepted Orders</a><br />
    ...
    <div class="footer-heading footer-4 option2">
        <h2>Maps</h2>
        <a href="https://goo.gl/maps/EXUFRzFMCEasMyH16"><img class="map" src="adi_asserts/map.png" height="160px" width="250px" /></a>
    </div>
</div>
