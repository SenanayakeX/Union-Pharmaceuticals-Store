...
<div class="footerp">
    ...
    <div class="footer-head footer-2 option1 option2">
        ...
        <a href="/aa">Home</a><br />
        <a href="/orders">Accepted Orders</a><br />
        <a href="/view">Delivery Notes</a><br />
        <a href="/search">Delivery Report</a><br />
    ...
    <div class="footer-head footer-4 option2">
        <h2>Maps</h2>
        <a href="https://goo.gl/maps/EXUFRzFMCEasMyH16"><img class="mapp" src="pas_asserts/map.png" height="160px" width="250px" /></a>
    </div>
</div>
